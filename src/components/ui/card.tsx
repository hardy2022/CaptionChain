...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-white/40 backdrop-blur-2xl text-slate-700 flex flex-col gap-6 rounded-2xl border border-white/30 py-8 shadow-xl",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-8 text-slate-700", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex items-center px-8 [.border-t]:pt-8 text-slate-500", className)}
      {...props}
    />
  )
}
